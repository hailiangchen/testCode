...
--
-- Host: localhost
-- Generation Time: 2017-03-26 18:30:19
...
INSERT INTO `51_bankcard` (`id`, `bankname`, `cardname`) VALUES
(102033, '广东发展银行', '广发理财通 '),
(103000, '农业银行', '金穗借记卡 '),
(185720, '昆明农联社', '金碧卡 '),
(303781, '中国光大银行', '阳光爱心卡 '),
...
(553242, '建设银行', '龙卡信用卡 '),
(556610, '民生银行', '民生贷记卡 '),
(556617, '中信实业银行', '中信MASTERCARD人民币+美金双币'),
...
(558916, '中信实业银行', '中信MASTERCARD人民币+美金双币'),
(566666, '沈阳市商业银行', '玫瑰卡 '),
(584016, '深圳农联社', '信通卡 '),
(601382, '中国银行', '长城电子借记卡 '),
(601428, '交通银行', '太平洋万事顺卡 '),
